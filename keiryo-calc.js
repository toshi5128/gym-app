...
;(function (root, factory) {
   ...
   * dose = 1回に飲む量（何粒か）／ timing = いつ飲むか／ note = 何のために飲むか（効果）。
   * ★粒数は商品ごとに濃度が違う。ここは一般的な目安で、設定から各自の商品に合わせて直せる。
   * ※ 医学的な指示ではない。持病・服薬がある場合は医師や薬剤師に相談すること。
   */
  var DEFAULT_SUPPS = [
    { id:'multivit', name:'マルチビタミン',   note:'食事で不足しがちなビタミン・ミネラルの底上げ' },
    /* id は 'fishoil' のまま（オメガ3＝フィッシュオイルで中身は同じ）。
       id を変えると、これまで「飲んだ」と付けた記録が別物あつかいになって消えるため。 */
    { id:'fishoil',  name:'オメガ3（EPA・DHA）', dose:'2粒（EPA＋DHA 約1,000mg）', timing:'1食目か2食目の食後',
      note:'関節と筋肉の炎症をしずめて回復を助ける。中性脂肪を下げて血管と心臓を守る。魚を食べない日の穴うめ' },
